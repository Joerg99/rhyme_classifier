...
tf.flags.DEFINE_string("training_files", "train_data_pos.train", "training file (default: None)")  # Eingabe fuer Trainingsdaten ..... for sentence semantic similarity use "train_snli.txt"
# train_data_chicago.train person_match.train
...
with tf.Graph().as_default():
    ...
    def train_step(x1_batch, x2_batch, y_batch):
        ...
        print('Y kommt hier', y_batch, dist, 'Das ist sim: ', sim)
